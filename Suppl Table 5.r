...
# SOCIAL DILEMMA
# Model 1a
m1a<-glm(SDpayInfo ~ country + IOS + SWconformity + age + gender + siblings+  knownParticipants + religious +
...
# COORDINATION GAME
# Model 2a
m2a<-glm(COpayInfo ~ country + IOS + SWconformity + age + gender + siblings+  knownParticipants + religious +
SWbenevolence + SWuniversalism + SWselfdirect + SWstimulation + SWhedonism + SWachievement + 
SWpower + SWsecurity + SWtradition + riskTaking + FGFtype, family='binomial', data=data)
summary(m2a)
...
# COORDINATION GAME
# Model 2a
m3a<-glm(BCpayInfo ~ country + IOS + SWconformity + age + gender + siblings+  knownParticipants + religious +
SWbenevolence + SWuniversalism + SWselfdirect + SWstimulation + SWhedonism + SWachievement + 
SWpower + SWsecurity + SWtradition + riskTaking + FGFtype, family='binomial', data=data)
summary(m3a)
